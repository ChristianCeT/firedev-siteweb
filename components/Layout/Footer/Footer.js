...
const footer = () => {
  return (
    <div>
      ...
      <div className="bg-indigoPrimary text-whitePrimary h-full pt-[170px] px-10 flex flex-col items-center lg:h-[500px] lg:justify-between lg:flex-row  lg:pt-0">
        ...
        <div className="h-full w-full mb-10 flex flex-col justify-end text-center pb-14 lg:w-[30%] md:pb-0">
          <h1 className="font-semibold text-xl mb-4">Redes sociales</h1>
        ...
        <div className="h-full w-full mb-10 flex flex-col justify-center text-center lg:w-[30%]">
          <h1 className="font-semibold text-xl mb-2">Información adicional</h1>
