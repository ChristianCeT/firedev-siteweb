...
const Main = () => {
  return (
    <>
      <section className="bg-indigoPrimary flex justify-around pt-32 items-center text-center flex-col md:flex-row">
        ...
        <div className="text-whitePrimary text-3xl font-bold">
          ...
          <button className="bg-rosePrimary rounded-lg py-3 px-2 font-bold">
            CONTÁCTANOS
          </button>
        </div>
