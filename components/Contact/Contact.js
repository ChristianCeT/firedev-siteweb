    ...
    <div className="relative flex justify-center mb-40">
      <div className="bg-whitePrimary w-[92%] shadow-lg shadow-slate-700 rounded-xl absolute md:w-[58%]">
        <div className="flex justify-center">
          <h1 className="text-orangePrimary py-2 text-4xl font-semibold after:block after:w-[63%] after:h-1 after:bg-orangePrimary">
            CONTACTO
          </h1>
        </div>
        <form onSubmit={onHandleSubmit} className="flex justify-evenly">
          <div className="w-[90%] flex flex-col my-10 xl:w-[38%]">
            {dataInputLabel.map((dataIn, index) => (
              <div key={index} className="flex flex-col">
                ...
                <input
                  ...
                  className="h-[30px] bg-color-gris-negro border-b-[2.3px] border-orangePrimary focus:invalid:border-red-500 focus:outline-none valid:border-orangePrimary"
                  type={dataIn.type}
            ...
            <textarea
              ...
              required={true}
              onChange={handlChange}
              className="h-[9rem] pl-1 bg-color-gris-negro resize-none border-[2.3px] border-orangePrimary focus:border-orangePrimary rounded-md focus:invalid:border-red-500 focus:outline-none valid:border-orangePrimary"
            ></textarea>
            <button
              type="submit"
              className="text-orangePrimary w-[50%] mx-auto mt-3 px-5 py-2 rounded-md border-[3px] border-orangePrimary font-semibold"
            >
              ENVIAR
            </button>
            ...
            {message ? (
              <div
                className={`mt-3 rounded-lg cursor-pointer bg-blackPrimary`}
              >
